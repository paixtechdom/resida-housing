...
export const Navbar:FC = () => {
    ...
    return(
        <>
           <>
        <header className={`fixed center w-full left-0 top-0 h-[10vh] md:h-[12vh] z-50 transition-all duration-1000 bg-white`}>
            <div className="flex items-center justify-between w-11/12 lg:w-10/12">
                ...
                <Link to={'/'} className='w-3/12 md:w-2/12 flex items-center gap-3'>
                    ...
                    <span className="text-xl font-bold text-primary">Redisa</span>
                </Link>
