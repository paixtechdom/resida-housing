...
export const Download = () => {
    return(
        <div className="center w-full relative">
            <div className="w-11/12 lg:w-10/12 xl:w-9/12 center flex-col lg:flex-row gap-[50px]">
                <div className="flex flex-col gap-6">
                    <h2 className="text-5xl font-bold text-primary lg:w-5/12">Download our App</h2>
